    ...
    <div className="relative w-full h-screen flex flex-col overflow-hidden bg-gradient-to-br from-[#f5f5f7] via-[#eef0f5] to-[#f0f2f8] dark:bg-gradient-to-br dark:from-[#131314] dark:via-[#0e0e0f] dark:to-[#131314] transition-colors duration-300">
      {isAdmin ? (
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden w-full h-full md:p-4 md:gap-4">
          ...
          <main className="flex-1 overflow-y-auto overflow-x-hidden relative bg-gradient-to-tr from-[#f0f2f8] to-[#f5f5f7] dark:bg-[#18181f]/95 backdrop-blur-2xl md:rounded-2xl border-t md:border border-gray-200/60 dark:border-white/[0.09] shadow-[0_8px_32px_rgba(0,0,0,0.02)] custom-scrollbar pb-24 md:pb-0">
            ...
            <div className="min-h-full px-1.5 sm:px-4 py-4 md:p-8 pt-20 md:pt-8">
