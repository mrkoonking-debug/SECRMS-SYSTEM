...
export const ClaimsList: React.FC = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-3 md:px-6 pb-24 md:pb-8">
            ...
            {/* ── Search + Filters ── */}
            <div className="bg-gray-50 dark:bg-white/[0.03] rounded-xl md:rounded-2xl shadow-sm border border-gray-200/80 dark:border-white/[0.08] p-1.5 mb-5 md:mb-6 sticky top-14 md:top-0 z-30 flex flex-col md:flex-row md:items-center gap-1 md:gap-2">
                                ...
                                {isDateExpanded && (
                                    <div className="space-y-3 md:space-y-4 pl-3 md:pl-0">
                                        {sortedJobKeys.map(jobKey => {
                                            ...
                                            return (
                                                <div key={jobKey} onClick={() => handleJobClick(jobKey)} className={`bg-gray-50/80 dark:bg-white/[0.03] rounded-[20px] md:rounded-[24px] overflow-hidden border cursor-pointer transition-all duration-200 group will-change-transform ${isJobDone ? 'border-green-200/60 dark:border-green-500/10' : 'border-gray-200/80 dark:border-white/[0.08]'} hover:shadow-md hover:shadow-black/[0.03] dark:hover:shadow-black/30 hover:-translate-y-0.5 hover:border-blue-200 dark:hover:border-blue-500/20 active:scale-[0.99] active:translate-y-0`}>
