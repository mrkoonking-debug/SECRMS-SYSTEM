...
export const ClaimsList: React.FC = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 pb-24 md:pb-8">
            {/* ── Header ── */}
            ...
            <div className="bg-white dark:bg-[#16161a] rounded-xl md:rounded-2xl shadow-[0_2px_8px_rgba(0,0,0,0.04)] dark:shadow-none border border-gray-200/60 dark:border-white/[0.08] p-1.5 mb-5 md:mb-6 sticky top-14 md:top-0 z-30 flex flex-col md:flex-row md:items-center gap-1 md:gap-2">
                ...
                <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide w-full md:w-auto px-1 pb-1 md:pb-0">
                    ...
                    <div className="bg-gray-100 dark:bg-white/[0.04] p-0.5 rounded-full grid grid-cols-4 items-center relative w-full min-w-[340px] md:min-w-[420px] md:max-w-[420px] flex-shrink-0">
                        ...
                        {['ALL', 'PENDING', 'IN_PROGRESS', 'DONE'].map((s) => (
                            <button 
                                ...
                                className={`relative z-10 px-3 py-1.5 md:px-3.5 md:py-2 text-[10px] md:text-xs font-semibold rounded-full transition-colors duration-200 whitespace-nowrap text-center outline-none focus:outline-none ${
                                    statusFilter === s 
                                        ? 'text-white' 
