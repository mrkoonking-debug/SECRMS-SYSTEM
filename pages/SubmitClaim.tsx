    ...
    <div className="max-w-4xl mx-auto py-5 md:py-8 px-3 sm:px-4 md:px-6 pb-28 md:pb-8">
      {step === 'success' ? (
        <div className="min-h-[60vh] flex flex-col items-center justify-center text-center">
          <div className="bg-white dark:bg-[#16161a] apple-liquid-glass rounded-[36px] sm:rounded-[42px] md:rounded-[50px] p-6 sm:p-10 md:p-14 max-w-2xl w-full shadow-2xl border border-gray-200/80 dark:border-white/[0.08]">
            ...
            <div className="bg-black/[0.03] dark:bg-black/40 p-6 rounded-[28px] border border-black/5 dark:border-white/10 apple-card-inner mb-8">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-3">
              <button
                ...
                className="px-8 py-3.5 bg-gray-100 hover:bg-gray-200 dark:bg-white/10 dark:hover:bg-white/15 text-[#1d1d1f] dark:text-white rounded-full font-extrabold text-sm transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="px-8 py-3.5 bg-[#0071e3] hover:bg-[#0077ed] text-white rounded-full font-extrabold text-sm shadow-lg shadow-blue-500/25 transition-all hover:scale-[1.02] active:scale-[0.98] cursor-pointer"
              >
        ...
        <>
          ...
          <div className="flex items-center justify-between gap-4 mb-6 md:mb-8 px-1">
            ...
            {basket.length > 0 && (
              <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-black/[0.04] dark:bg-black/40 border border-black/5 dark:border-white/10 apple-card-sm text-right">
          ...
          <div className="bg-white dark:bg-[#16161a] apple-liquid-glass rounded-[32px] sm:rounded-[38px] md:rounded-[44px] p-6 sm:p-8 md:p-10 mb-6 md:mb-8 border border-gray-200/80 dark:border-white/[0.08] shadow-md">
            <div className="flex items-center gap-3.5 mb-6 md:mb-8">
              <div className="w-9 h-9 md:w-10 md:h-10 rounded-[15px] md:rounded-[17px] bg-[#0071e3] text-white flex items-center justify-center text-xs md:text-sm font-black shadow-md shadow-blue-500/25 apple-card-sm flex-shrink-0">
                1
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 mb-4 md:mb-5">
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">{t('publicSubmit.quotationNo')}</label>
                <input
                ...
                />
                {errors.quotationNumber && touched.quotationNumber && <p className="text-red-500 text-xs mt-1.5 ml-3 font-medium">{errors.quotationNumber}</p>}
              </div>
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">{t('publicSubmit.companyName')} <span className="text-red-500 font-bold">*</span></label>
                <input
                  value={customer.name}
                ...
                />
                {errors.name && touched.name && <p className="text-red-500 text-xs mt-1.5 ml-3 font-medium">{errors.name}</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 mb-4 md:mb-5">
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">{t('publicSubmit.contactName')} <span className="text-red-500 font-bold">*</span></label>
                <input
                ...
                />
                {errors.contactPerson && touched.contactPerson && <p className="text-red-500 text-xs mt-1.5 ml-3 font-medium">{errors.contactPerson}</p>}
              </div>
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">{t('publicSubmit.phone')} <span className="text-red-500 font-bold">*</span></label>
                <input
                ...
                />
                {errors.phone && touched.phone && <p className="text-red-500 text-xs mt-1.5 ml-3 font-medium">{errors.phone}</p>}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 mb-4 md:mb-5">
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">{t('submit.lineId')}</label>
                <input
              ...
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">Email (Optional)</label>
                <input
            ...
            <div className="grid grid-cols-1 gap-4 md:gap-5">
              <div>
                <label className="block text-[10.5px] md:text-xs font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider mb-1.5 ml-2">{t('submit.returnAddress')}</label>
                <textarea
                  value={customer.returnAddress}
                  onChange={e => setCustomer({ ...customer, returnAddress: e.target.value })}
                  rows={2}
                  className={`w-full px-4 py-3 md:px-5 md:py-3.5 text-xs md:text-sm apple-card-inner rounded-[24px] md:rounded-[28px] outline-none transition-all bg-gray-50/70 dark:bg-white/[0.03] border border-gray-200/80 dark:border-white/[0.08] text-[#1d1d1f] dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:bg-white dark:focus:bg-[#1c1c20] focus:ring-2 focus:ring-[#0071e3]/30 focus:border-[#0071e3]`}
          ...
          {/* Section 2: Add Item */}
          <div className="bg-white dark:bg-[#16161a] apple-liquid-glass rounded-[32px] sm:rounded-[38px] md:rounded-[44px] p-6 sm:p-8 md:p-10 mb-6 md:mb-8 border border-gray-200/80 dark:border-white/[0.08] shadow-md relative overflow-hidden">
            <div className="flex items-center gap-3.5 mb-6 md:mb-8">
              <div className="w-9 h-9 md:w-10 md:h-10 rounded-[15px] md:rounded-[17px] bg-[#0071e3] text-white flex items-center justify-center text-xs md:text-sm font-black shadow-md shadow-blue-500/25 apple-card-sm flex-shrink-0">
                2
              </div>
          ...
          {basket.length > 0 && (
            <div className="bg-white dark:bg-[#16161a] apple-liquid-glass rounded-[32px] sm:rounded-[38px] md:rounded-[44px] p-6 sm:p-8 md:p-10 mb-6 md:mb-8 border border-gray-200/80 dark:border-white/[0.08] shadow-md animate-fade-in">
              <div className="flex justify-between items-center mb-6 md:mb-8">
                <div className="flex items-center gap-3.5">
                  <div className="w-9 h-9 md:w-10 md:h-10 rounded-[15px] md:rounded-[17px] bg-emerald-500 text-white flex items-center justify-center text-xs md:text-sm font-black shadow-md shadow-emerald-500/25 apple-card-sm flex-shrink-0">
                    3
                  </div>
                  <h2 className="font-extrabold text-base md:text-xl text-[#1d1d1f] dark:text-white tracking-tight">
                ...
                <button 
                  onClick={() => setBasket([])} 
                  className="px-3.5 py-1.5 rounded-full text-xs font-bold text-red-500 hover:text-white hover:bg-red-500/90 dark:hover:bg-red-500/80 transition-all cursor-pointer"
                >
              ...
              <div className="space-y-4">
                {basket.map((item, idx) => (
                  <div key={item.id} className="p-4 md:p-5 bg-black/[0.02] dark:bg-white/[0.03] apple-card-inner rounded-[24px] md:rounded-[28px] border border-gray-200/70 dark:border-white/[0.06] hover:border-[#0071e3]/30 transition-all flex items-start justify-between gap-3">
                        ...
                        {item.accessories.length > 0 && (
                          <div className="flex flex-wrap gap-1 mb-1.5">
                            {item.accessories.map((acc: string) => (
                              <span key={acc} className="text-[10px] font-medium px-2.5 py-0.5 bg-black/5 dark:bg-white/[0.06] rounded-full text-gray-600 dark:text-gray-300 border border-black/5 dark:border-white/5">
                                {formatAccessory(acc)}
                              </span>
                            ))}
                          </div>
                    ...
                    <button 
                      ...
                      className="p-2 text-gray-400 hover:text-red-500 rounded-full hover:bg-red-50 dark:hover:bg-red-900/20 transition-all cursor-pointer"
                      title="ลบรายการนี้"
                    >
              ...
              <div className="mt-8 pt-6 border-t border-black/5 dark:border-white/5">
                <button
                  ...
                  className="w-full py-4 bg-[#0071e3] hover:bg-[#0077ed] disabled:bg-gray-400 text-white rounded-full font-extrabold text-base md:text-lg shadow-xl shadow-blue-500/25 transition-all hover:scale-[1.01] active:scale-[0.98] flex items-center justify-center gap-3 cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
