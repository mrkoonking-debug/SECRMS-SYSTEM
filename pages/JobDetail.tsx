...
export const JobDetail: React.FC = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-8">
            ...
            <div className="bg-white dark:bg-[#1c1c1e] rounded-[24px] p-6 sm:p-8 mb-8 border border-gray-100 dark:border-[#333] shadow-sm ios-squircle">
            ...
            <div className="space-y-4">
                ...
                {rmas.map((item, index) => {
                    ...
                    return (
                        <div key={item.id} className={`bg-white dark:bg-[#1c1c1e] rounded-[20px] p-6 transition-all hover:bg-gray-50 dark:hover:bg-[#2c2c2e] border-2 ${isSelected ? 'border-[#0071e3] ring-2 ring-[#0071e3]/20' : 'border-gray-100 dark:border-[#333]'} ios-squircle`}>
